...
/*public void stampaElencoAbbonamenti (ArrayList<abbonamento> elenco) throws Exception{
	    ...
	    Row<PDPage> headerRow = table.createRow(50);
	    // the first parameter is the cell width
	    Cell<PDPage> cell = headerRow.createCell(100, "ELENCO PRODOTTI");
	    cell.setFont(fontBold);
	    cell.setFontSize(20);
	    // vertical alignment
	    cell.setValign(VerticalAlignment.MIDDLE);
	    ...
	    Row<PDPage> row = table.createRow(20);
	    cell = row.createCell(30, "Prodotti");
	    cell.setFontSize(15);
	    cell = row.createCell(70, new Date().toString());
	    cell.setFontSize(15);
	    cell.setFont(fontBold);
	    ...
	    for(int i=0;i<elenco.size();i++)
	    {
	        ...
	        String id1=String.valueOf(a.getIdabbonamento());
	        cell = row.createCell(32,id1);
	        cell.setFontSize(12);
	        // long text that wraps, with more line spacing
	        cell = row.createCell(32,a.getInizio());
	        cell.setFontSize(12);
	        // long text that wraps, with more line spacing
	        cell = row.createCell(30,a.getFine());
	        cell.setFontSize(12); cell = row.createCell(32,a.getCodf());
	        cell.setFontSize(12);
	        // long text that wraps, with more line spacing
	        cell = row.createCell(32,a.getNomecorso());
	        cell.setFontSize(12);
	        // long text that wraps, with more line spacing
